...
final readonly class GenerateCashDisbursementsBook extends GenerateBook
{
    ...
    {
        return 'cash_disbursements_book';
    }

    protected function buildPayload(string $companyId, ReportPeriod $period): array
    {
        $rows = $this->aggregator->cashDisbursementsRows($companyId, $period);
