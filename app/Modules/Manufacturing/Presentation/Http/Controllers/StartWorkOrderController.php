...
use App\Modules\Manufacturing\Application\Actions\StartWorkOrder;
 ...
 *
 *   POST /api/v1/work-orders/{order}/start
 */
final class StartWorkOrderController
{
    public function __invoke(
        Request $request,
        StartWorkOrder $action,
        string $order,
    ): JsonResponse {
        try {
